...
export class CommonFiltersService {
    types = [
        {type:'numeric',value:[FilterOperator.EQ,FilterOperator.NOT,FilterOperator.NULL,FilterOperator.BTW,FilterOperator.GT,FilterOperator.GTE,FilterOperator.LTE,FilterOperator.LT]},
        {type:'bigint',value:[FilterOperator.EQ,FilterOperator.NOT,FilterOperator.NULL,FilterOperator.BTW,FilterOperator.GT,FilterOperator.GTE,FilterOperator.LTE,FilterOperator.LT]},
        ...
        {type:'date',value:[FilterOperator.EQ,FilterOperator.NOT,FilterOperator.NULL,FilterOperator.BTW,FilterOperator.GT,FilterOperator.GTE,FilterOperator.LTE,FilterOperator.LT]},
        {type:'timestamp',value:[FilterOperator.EQ,FilterOperator.NOT,FilterOperator.NULL,FilterOperator.BTW,FilterOperator.GT,FilterOperator.GTE,FilterOperator.LTE,FilterOperator.LT]}
    ];
